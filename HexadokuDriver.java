...
public class HexadokuDriver 
{
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        Backtracker solution = new Backtracker<Backtrackable<Character>, Character>(board);

        solution.solve(solution.getBacktrackableObject());

        board = solution.getBacktrackableObject();
